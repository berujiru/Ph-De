...
> medallion). Draw it at boss scale — the largest and heaviest of the three
> phases, more grotesque than a minion. Clean grid, one animation per row, evenly
> spaced, non-overlapping poses, on a transparent or solid white background.
> Consistent frame size and centering.
>
