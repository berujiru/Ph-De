...
export function createEnemyAnimations(scene: Phaser.Scene): void {
  ...
  // Custom manual sprite sheet configuration for Ghost Employee
  if (scene.textures.exists('ghost_employee') && !scene.anims.exists('ghost_employee-march')) {
    scene.anims.create({
      key: 'ghost_employee-march',
      frames: scene.anims.generateFrameNumbers('ghost_employee', { start: 1, end: 23 }),
      frameRate: 10,
      repeat: -1,
    });
    scene.anims.create({
      key: 'ghost_employee-attack',
      frames: scene.anims.generateFrameNumbers('ghost_employee', { start: 24, end: 35 }),
      frameRate: 10,
      repeat: 0,
    });
    scene.anims.create({
      key: 'ghost_employee-death',
      frames: scene.anims.generateFrameNumbers('ghost_employee', { start: 60, end: 74 }),
      frameRate: 10,
      repeat: 0,
    });
  }
  ...
  // Custom manual sprite sheet configuration for Red Tape
  if (scene.textures.exists('red_tape') && !scene.anims.exists('red_tape-march')) {
    scene.anims.create({
      key: 'red_tape-march',
      frames: scene.anims.generateFrameNumbers('red_tape', { start: 1, end: 18 }),
      frameRate: 10,
      repeat: -1,
    });
    scene.anims.create({
      key: 'red_tape-attack',
      frames: scene.anims.generateFrameNumbers('red_tape', { start: 26, end: 47 }),
      frameRate: 10,
      repeat: 0,
    });
    scene.anims.create({
      key: 'red_tape-death',
      frames: scene.anims.generateFrameNumbers('red_tape', { start: 68, end: 89 }),
      frameRate: 10,
      repeat: 0,
    });
  }
